...
public class TelaPrincipal extends JFrame {
	...
	public TelaPrincipal() {
		...
		URL url = this.getClass().getResource("/br/com/taf/img/login.png");
		...
		btnCliente.setBackground(Color.YELLOW);
		...
		btnAnimal.setBackground(Color.YELLOW);
		...
		btnAgenda.setBackground(Color.YELLOW);
		...
		btnAgendaParaHoje.setBackground(Color.YELLOW);
		...
		lbImagem.setBounds(0, 0, 505, 323);
